...
По мере формулирования и обнаружения скрытых требований, новых задач, предлагай необходимые дополнения к препромптам.
...
При необходимости импортировать известный тебе объект по неизвестному пути просто помечай его в блоке импортов комментарием, не запрашивай полный путь или модули-спецификации, не трать токены, я с помощью IDE могу сам прописать необходимые импорты корректно. В последующих диалогах я буду по возможности и необходимости присылать исправленные версии модули с актуальными импортами.
