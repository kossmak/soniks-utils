...
102. Именование очередей: Для каждой станции удобно использовать паттерн station.{id}.tasks, чтобы DLX мог возвращать метаданные о том, откуда "прилетело" протухшее сообщение.
