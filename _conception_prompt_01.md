...
- **Настройка TTL**: Время жизни сообщения в очереди RabbitMQ должно рассчитываться динамически для каждого пролета спутника (Tend−Tstart+buffer) / связанного с ним наблюдения.
